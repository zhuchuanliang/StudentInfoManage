...
<link rel="stylesheet" type="text/css" href="jquery-easyui-1.3.3/themes/default/easyui.css">
	<link rel="stylesheet" type="text/css" href="jquery-easyui-1.3.3themes/icon.css">
...
<script type="text/javascript">
   ...
   function deleteGrade(){
	   ...
	   var ids=strIds.join(",");
	   $.messager.confirm("系统提示","你确认要删除这"+selectedRows.length+"条数据吗？",function(r){
		   if(r){
...
<body>
<table id="dg" class="easyui-datagrid" title="班级信息" fitColumns="true" 
...
<div id="dlg" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
   <form id="fm" method="post">
   	  <table>
   	      <tr>
   	      	<td>班级名称：</td>
   	      	<td><input type="text" value="" name="gradeName" id="gradeName"></td>  
   	      </tr>
   	      <tr>
